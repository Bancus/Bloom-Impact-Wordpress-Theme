  ...
  <section id="feature">
    <div class="container">
      <div class="row">
        <img src="<?php bloginfo('template_url'); ?>/img/section-2.png" class="col-sm-4 col-xs-12 img-wrap-mini">
        ...
        <div class="row ">
          <div class="col-sm-6 col-md-4">
            <div class="partner-item">
              <img src="<?php bloginfo('template_url'); ?>/img/p1.png">
          ...
          <div class="col-sm-6 col-md-4">
            <div class="partner-item">
              <img src="<?php bloginfo('template_url'); ?>/img/p2.png">
          ...
          <div class="col-sm-6 col-md-4">
            <div class="partner-item">
              <img src="<?php bloginfo('template_url'); ?>/img/p3.png">
  ...
  <section id="call-to-action">
      ...
      <div class="col-sm-12 col-xs-12">
        <div class="input-group">
            ...
            <a style="cursor: pointer !important;" class="input-group-addon bloom">Text me the link</a>
          </div>
      <p class="sml-smz">Standard SMS rates may apply.</p>
      </div>
        </div>
   <div class="col-sm-6 ">
    <!--<a href="/playstore"><img src="<?php bloginfo('template_url'); ?>/img/app-str.png" class="col-xs-12 appstore"></a>-->
    <a href="https://play.google.com/store/apps/details?id=com.bloomimpact.bancus&hl=en" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/playstore.png" class="col-xs-12 playstore"></a>
      </div>
            ...
            <div class="block">
              <div id="clients-logo" class="owl-carousel">
                <div class="clients-logo-img">
                  <img src="<?php bloginfo('template_url'); ?>/img/logos/1.png" alt="Features">
                </div>
                <div class="clients-logo-img">
                  <img src="<?php bloginfo('template_url'); ?>/img/logos/2.png" alt="Features">
                </div>
                <div class="clients-logo-img">
                  <img src="<?php bloginfo('template_url'); ?>/img/logos/3.png" alt="Features">
                </div>
                <div class="clients-logo-img">
                  <img src="<?php bloginfo('template_url'); ?>/img/logos/4.png" alt="Features">
                </div>
                <div class="clients-logo-img">
                  <img src="<?php bloginfo('template_url'); ?>/img/logos/5.png" alt="Features">
                </div>
                <div class="clients-logo-img">
                  <img src="<?php bloginfo('template_url'); ?>/img/logos/6.png" alt="Features">
                </div>
                <div class="clients-logo-img">
                  <img src="<?php bloginfo('template_url'); ?>/img/logos/7.png" alt="Features">
                </div>
              </div>
            </div>
          </div>
